...
(
	...
	goods_sn varchar(16) null comment '商品编码',
	spu_id bigint null comment 'spuId',
	is_on_sale varchar(1) null comment '是否上架 Y：是 N：否',
	goods_price decimal null comment '商品单价',
	goods_img varchar(255) null comment '商品图片',
	column_7 int null,
	is_deleted varchar(1) default 'N' null comment '是否删除标记'
)
comment '商品表';
...
(
	...
	address varchar(128) null comment '详细收获地址',
	order_amount decimal null comment '订单金额',
	ship_fee decimal null comment '物流费用',
	remark varchar(256) null comment '订单备注',
	order_sn varchar(64) null comment '订单编码',
	store_id varchar(16) null comment '在哪个店铺下单',
	order_status varchar(64) null comment '订单状态',
	shipping_status varchar(64) null comment '物流状态',
	is_deleted varchar(1) default 'N' null comment '是否删除标记'
)
comment '订单表';
...
(
	...
	store_nick_name varchar(64) null comment '店铺昵称',
	contact_name varchar(64) null comment '联系人姓名',
	contact_mobile varchar(11) null comment '联系人手机号',
	biz_brand varchar(128) null comment '店铺主营品牌',
	biz_cat varchar(128) null comment '店铺经营分类',
...
',
	...
	store_address varchar(125) null comment '店铺详细地址',
	business_time_begin varchar(64) null comment '营业时间-开始',
	business_time_end varchar(64) null comment '营业时间-结束'
)
comment '店铺表';
